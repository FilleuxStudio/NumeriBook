...
namespace PPE
{
    public partial class FRM_Editer : Form
    {
        ...
        public FRM_Editer(Bibliotheque bibli, Livres chemin, int choix)
        {
            charge = choix;
            biblio = bibli;
            InitializeComponent();
        ...
        private void SaveAll()
        {
            ...
            foreach (string sFileName in System.IO.Directory.GetFiles(sPath, str, SearchOption.AllDirectories))
            {
                if (Path.GetFileName(sFileName) == str)
                {
